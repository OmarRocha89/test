    ...
    ?>
        ...
        <div id="camara" class="base w100 px-5 pb-5">
            ...
            <div class="base w100 text-center py-3">
                <p class="color-blue"> <strong> Coloca dentro del margen tu identificacion </strong></p>
                <p class="caption-text my-2">Recuerda tomar fotografía de tu INE o PASAPORTE</p>

            </div>


            <!-- Stream video via webcam -->
            <div class="video-wrap base w100 text-center" >
